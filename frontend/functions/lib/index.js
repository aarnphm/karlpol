...
exports.directions = functions.https.onRequest((request, response) =>
...
exports.solve = functions.https.onRequest((request, response) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        const people = yield Promise.all(
        ...
        while (!isDone(remainDrivers, remainPassengers)) {
            ...
            if (remainPassengers.length > 0) {
                ...
                minDriver.location.latlng = {
                    lat:
                        nextPassenger === null || nextPassenger === void 0 ? void 0 : nextPassenger.location.latlng.lat,
                    lng:
                        nextPassenger === null || nextPassenger === void 0 ? void 0 : nextPassenger.location.latlng.lng,
                };
